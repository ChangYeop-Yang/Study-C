...
- description: 바이트 단위의 디렉토리 및 각 파일의 용량 추가 된 ls
*/
#include <stdio.h>
#include <sys/types.h>
#include <dirent.h>
...
- description: Bloack 단위의 전체 파일 크기를 포함한 ls
*/
#include <stdio.h>
#include <sys/types.h>
#include <dirent.h>
...
- description: 퀵정렬을 이용하여 파일의 오름차순으로 정렬하여 출력하는 ls
*/
#include <stdio.h>
#include <sys/types.h>
#include <stdlib.h>
...
- description: 기존 ls는 인자를 받아 구현하지 못하는 부분을 해결한 ls
*/
#include <stdio.h>
#include <sys/types.h>
#include <stdlib.h>
